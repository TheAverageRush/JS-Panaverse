...
function make_album(artist, title, tracks = 0)
    {
        if (tracks == 0)
            ...
            {
                album_info = {artist: artist, title : title, tracks : tracks};
            }
        
        return console.log(album_info);
    }

make_album(`Junaid`, `Awaz`);
make_album(`Kashmir`, `Pukar`);
make_album(`Call`, `Ghost`);
make_album(`Fire fighter`, `Water`, 23);